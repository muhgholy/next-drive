...
export const DriveUpload = (props: Readonly<{ compact?: boolean; onComplete?: (item: unknown) => void }>) => {
     ...
     const { currentFolderId, refreshItems, apiEndpoint, activeAccountId, withCredentials } = useDrive();
     const { uploads, uploadFiles, cancelUpload, cancelAllUploads } = useUpload(apiEndpoint, activeAccountId, withCredentials, () => {
          refreshItems();
          onComplete?.(null);
     });
