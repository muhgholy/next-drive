    ...
    if (compact) {
        return (
            <div className={cn("nd-flex nd-items-center nd-gap-3 nd-text-xs nd-font-medium nd-text-muted-foreground", className)}>
                ...
                <Progress value={percentage} indicatorClassName={cn("nd-bg-gradient-to-r nd-from-blue-500 nd-to-cyan-500", isNearFull && "nd-from-yellow-500 nd-to-orange-500", isFull && "nd-bg-destructive")} className="nd-w-24 sm:nd-w-32" />
