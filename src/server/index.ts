...
import { validateMimeType, moveFile } from '@/server/utils';
import * as schemas from '@/server/zod/schemas';
import { sanitizeContentDispositionFilename } from '@/server/security/cryptoUtils';
                ...
                if (currentUploadId) {
                    ...
                    try {
                        ...
                        if (uploadedParts.length === totalChunks) {
                            ...
                            // Wait for stream to finish writing before proceeding
                            ...
                            if (meta.providerName === 'LOCAL' && drive.information.type === 'FILE') {
                                ...
                                // Path is relative to storage.path, so just use <id>/data<ext>
